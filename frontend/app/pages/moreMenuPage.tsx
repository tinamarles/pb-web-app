...
import { Icon, Avatar, Button, MenuItem } from '@/app/ui';
import { useAuth } from '@/app/providers/AuthUserProvider';
import { Module } from '@/app/shared';
import { MORE_MENU_SECTIONS, MORE_MENU_FOOTER_LINKS } from '@/app/data';
      ...
      <div className="min-h-full pb-24">
        ...
        <div className="more-menu__top-section">
          ...
          >
            ...
            <Icon name="chevronright" className="icon-md text-on-surface-variant" />
          </Link>
