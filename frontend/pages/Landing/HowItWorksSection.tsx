...
const steps = [
  {
    ...
    description: "Sign up and set up your player or club profile in minutes. Add your preferences and connect with your clubs.",
    icon: "profile",
  ...
  },
  {
    ...
    description: "Browse available leagues at your clubs and enroll, or create new leagues if you're a club administrator.",
    icon: "leagues",
  ...
  },
  {
    number: "03",
    title: "Track & Connect",
    description: "Monitor your progress, view statistics, and stay connected with your pickleball community.",
    icon: "performance",
        ...
        <div className="flex flex-col gap-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3xl md:gap-xl">
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="relative flex flex-col items-center gap-lg">
                  ...
                  <div className={`relative z-10 w-24 h-24 rounded-full ${colors.circleBg} flex items-center justify-center shadow-elevation-md transition-transform duration-200 hover:scale-110`}>
                  ...
                  <div className="flex flex-col gap-sm items-center text-center max-w-xs">
                    ...
                    <div className="flex items-center gap-md">
                      <div className={`w-12 h-12 rounded-full border-2 ${colors.circleBg} ${colors.connector} flex items-center justify-center flex-shrink-0`}>
                        <Icon 
                          name={step.icon} 
