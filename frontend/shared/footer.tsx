...
const FOOTER_DESCRIPTION =
  "Your ultimate pickleball companion. Connect, play, and improve your game with our comprehensive platform." as const;
const COPYRIGHT_DESCRIPTION =
  "© 2025 Pickle Hub. All rights reserved." as const;
