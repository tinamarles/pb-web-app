...
export function CTASection() {
  return (
    <section className="relative overflow-hidden bg-primary">
      ...
      <div
        className="relative z-10 max-w-7xl mx-auto py-section-mobile p-card
        ...
        <div className="text-center">
          <div className="flex flex-col gap-2xl items-center">
            ...
            <div className="flex flex-col gap-lg max-w-4xl">
              <h2
                className="headline-lg text-on-primary
                             sm:display-sm
                             lg:display-md"
              >
                Ready to Find Your
                <br />
                <span className="slogan-sm lg:slogan-md">
                  Perfect Pickleball Match?
                </span>
              </h2>

              <p className="body-lg text-on-primary/80 max-w-2xl mx-auto">
                Join the fastest-growing pickleball community. Sign Up with
                Pickle Hub today and discover amazing clubs, coaches, exciting
            ...
            {/* CTA Buttons */}
            <div
              className="flex flex-col gap-md items-center w-full
